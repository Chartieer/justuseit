...
class Contrast {
  constructor(options = {}) {
    this.isCustomColors =
      typeof options.isCustomColors !== 'undefined'
        ? options.isCustomColors
        : false;
    this.customLight =
      typeof options.customLight !== 'undefined'
        ? options.customLight
        : '#FFFFFF';
    this.customDark =
      typeof options.customDark !== 'undefined'
        ? options.customDark
        : '#000000';
    this.isDiv = typeof options.isDiv !== 'undefined' ? options.isDiv : false;
    this.isResponsive =
      typeof options.isResponsive !== 'undefined' ? options.isResponsive : true;
    this.bgClass =
      typeof options.bgClass !== 'undefined' ? options.bgClass : 'contrast-bg';
    this.elementClass =
      typeof options.elementClass !== 'undefined'
        ? options.elementClass
        : 'contrast-el';
    this.backgroundSize =
      typeof options.backgroundSize !== 'undefined'
  ...
  invertColor() {
    ...
    this.invertedHex =
      '#' + this.padZero(r) + this.padZero(g) + this.padZero(b);
    return this;
  }
